"""
Simple smoke tests for MCP server in-process (inside container).
Usage inside container:
  API_KEY=test-key TOOL_SCHEMA_DIR=/app/app/tools .venv/bin/python -m app.smoke_test
"""
import os

os.environ.setdefault("API_KEY", "test-key")
os.environ.setdefault("LOG_LEVEL", "DEBUG")
os.environ.setdefault("TOOL_SCHEMA_DIR", os.path.abspath(os.path.join(os.path.dirname(__file__), "tools")))
